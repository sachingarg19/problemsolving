 ...
 * true if the item was not present, false otherwise. bool remove(int val)
 ...
 * being returned. Follow up: Could you implement the functions of the class
 ...
 * Constraints:
 * 
 * -231 <= val <= 231 - 1 At most 105 calls will be made to insert, remove, and
 * getRandom. There will be at least one element in the data structure when
 * getRandom is called.
 *
 * 
 */
class RandomizedSet {
  ...
  public boolean insert(int val) {
    ...
    // System.out.println("insert - " + randomMap);
    return true;
  }
  ...
  public boolean remove(int val) {
    if (randomMap.containsKey(val)) {
      ...
      // System.out.println("remove - " + randomMap);
      return true;
    }
    return false;
  }
  ...
  public int getRandom() {
    Object[] values = randomMap.values().toArray();
